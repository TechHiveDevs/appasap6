...
import ListFundsScreen from "../Entities/Funds/List.funds.screen";
import ShowFundsScreen from "../Entities/Funds/Show.funds.screen";
  ...
  return (
    <Stack.Navigator {...stackrops}>
      ...
      />
        ...
        <Stack.Screen
            name="ListFundsScreen"
            component={ListFundsScreen}
            options={screenOptions}
          />
          <Stack.Screen
          name="ShowFundsScreen"
          component={ShowFundsScreen}
          options={screenOptions}
        />
